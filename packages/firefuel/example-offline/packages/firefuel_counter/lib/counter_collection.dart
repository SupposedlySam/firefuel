  ...
  Future<Counter> increment({
    ...
    return _createIfNotExists(
      ...
      onRead: (currentCounter) async {
        ...
        update(docId: docId, value: incrementedCounter);

        print('counterLog: Incrementing to $incrementedCounter');
  ...
  Future<Counter> decrement({
    ...
    return _createIfNotExists(
      ...
      onRead: (currentCounter) async {
        ...
        update(docId: docId, value: decrementedCounter);

        print('counterLog: Decrementing to $decrementedCounter');
