...
typedef FutureCallback<R, T extends Serializable> =
    Future<Either<Failure, R>> Function(TestRepository<T>);
typedef StreamCallback<R, T extends Serializable> =
    Stream<Either<Failure, R>> Function(TestRepository<T>);
