...
abstract class FirefuelCollectionBase<T extends Serializable>
    implements Collection<T> {
  final CollectionReference<Map<String, dynamic>> _untypedRef;

  FirefuelCollectionBase(this._untypedRef);

  CollectionReference<Map<String, dynamic>> get untypedRef => _untypedRef;
  ...
  @protected
  Query<T?> getWhereWithOrderByAndLimitQuery({
  ...
  Stream<List<T>> streamWhere(
    ...
    final query = getWhereWithOrderByAndLimitQuery(
      clauses: clauses,
      orderBy: orderBy,
      limit: limit,
    );
